      ...
      message.channel.send({
        embed: {
          ...
          description: `To get the list of commands, type \`${message.guild.prefix[0]}commands\`.` +
                       ...
                       `\n\nNeed help or support with EeveeOrigins Bot?\n${message.guild.id === '267022940967665664' ? 'Ask for help in the guild.' : ' Join [**EeveeOrigins**](https://discord.gg/tanzTMF) for testing the commands or any help you need with the bot or maybe just for fun.\nhttps://discord.gg/fzx8fkt'}`,
          fields: [
            {
              name: 'EeveeOrigins Invite Link',
              value: 'https://discord.gg/tanzTMF'
            },
            {
              name: 'EeveeOrigins Bot Invite Link',
