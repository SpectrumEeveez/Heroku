    ...
    if (args.name) {
      ...
      message.channel.send({
        embed: {
          ...
          description: `My activity is now set to **${args.type} ${args.name}** :white_check_mark: `
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
      ...
      message.channel.send({
        embed: {
          color: Bastion.colors.GREEN,
          description: `My activity has been reset to the default: **${Bastion.config.game.type} ${game}** :white_check_mark: `
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
